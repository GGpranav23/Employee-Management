      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-4 p-4 bg-white/5 rounded-xl">
            ...
            <div>
              <p className="text-white font-medium">Task "Design Database Schema" completed by Carol Davis</p>
          ...
          <div className="flex items-start space-x-4 p-4 bg-white/5 rounded-xl">
            ...
            <div>
              <p className="text-white font-medium">New task "Mobile Responsive Design" assigned to Bob Smith</p>
